...
public class Sign extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //서버를 위한 할당
        userInfoService = RetrofitClient.getRetrofitInstance().create(UserInfoService.class);
        ...
        signButton.setOnClickListener(v -> {
            if(pwCheck)
            {
                ...
                UserInfo userInfo = new UserInfo(userInfoID, userInfoPW, userInfoName, userInfoBirth, 0);

                Call<UserInfo> call = userInfoService.createUserInfo(userInfo);
